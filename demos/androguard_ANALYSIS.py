...
# display_PACKAGES(a,d,dx)
# display_PACKAGES_IE(a,d, dx)
# display_PACKAGES_II(a,d, dx)
# display_PERMISSION(a,d, dx)
# # display_SEARCH_PACKAGES(a,d,dx,)
